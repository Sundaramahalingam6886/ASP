<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tenth.aspx.cs" Inherits="Tenth" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:companyConnectionString %>" 
                ...
                SelectCommand="SELECT id, name, passwrd, Desig, city, salary, gender FROM auditor WHERE (id BETWEEN 17 AND 28)"></asp:SqlDataSource>
