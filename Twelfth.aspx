<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Twelfth.aspx.cs" Inherits="Twelth" %>
...
<h3>Twelfth Week</h3>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT id, name, passwrd, Desig, city, salary, gender FROM auditor WHERE (id BETWEEN 41 AND 52)"></asp:SqlDataSource>
